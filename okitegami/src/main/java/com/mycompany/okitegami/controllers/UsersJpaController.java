...
public class UsersJpaController implements Serializable {
    ...
    public void create(Users users) throws RollbackFailureException, Exception {
        ...
        try {
            ...
            try {
                ...
                System.out.println("Error creación:"+ex.getCause().getMessage());
                utx.rollback();
            } catch (Exception re) {
    ...
    public Users findByEmail(String email){
        try{
            ...
            System.out.println("Error find email: "+e.toString());
            return null;
        }
    }
    ...
    public File getFileImage() {
        String path="C:\\Users\\meli_\\OneDrive\\Imágenes\\vlcsnap-2023-03-11-14h00m51s589.png";
