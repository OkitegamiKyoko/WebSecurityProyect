...
@Named("graficEnvios")
@SessionScoped
public class GraficLineEnvios implements Serializable {
    ...
    public LineChartModel createDrawArea(List<Envios> env) {
        ...
        if (env!=null) {
            ...
            title.setText("Envios totales en el año");
    ...
    public List<Object> datos(List<Envios> env){
        ...
        for (int i = 0; i < size; i++) {
                ...
                Envios envio=env.get(i);
                time.setTime(envio.getIdContrato().getCreacion());
